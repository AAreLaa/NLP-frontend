...
function App() {
  ...
  return (
    <>
      <Router>
        {/* excluded props from navbar: title3="Probable Words" title4="Sentiment Analysis" title5="Word Embeddings"  */}
        <Navbar toggle={toggle} mode={mode} title="NLP-Web" title1="Home" title2="Text Generator" title6="Spell Checker"/>
